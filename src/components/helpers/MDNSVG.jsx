export default function MDNSVG() {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M42 .2 13.4 92.3H1.7L30.2.2H42zm10.4 0v92.1H42V.2h10.4zm40.3 0L64.2 92.3H52.5L81 .2h11.7zm10.4 0v92.1H92.7V.2h10.4zM294 95h67v8.8h-67V95z"
        style={{
          fill: "var(--vivid)",
        }}
      />
